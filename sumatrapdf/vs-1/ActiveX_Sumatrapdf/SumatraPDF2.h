...
void BeginSign(WindowInfo& info);
void DrawSign(WindowInfo& win, HDC hdc, LPCWSTR image);
void SignPdf(WindowInfo& win,int page,int x,int y, LPCWSTR sourcePdf, LPCWSTR destPdf, LPCWSTR jpg, LPCWSTR owner, LPCWSTR issuer);
